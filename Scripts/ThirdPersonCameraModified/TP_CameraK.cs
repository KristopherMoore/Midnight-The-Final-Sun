...
public class TP_CameraK : MonoBehaviour
{
    ...
    public static TP_CameraK Instance;
    ...
    private float StartOffsetDistance = 1.6f;        //negative shifts the distance away from the player in front fromt he starting position.
    ...
    public static void UseExsistingOrCreateNewMainCamera()
    {
        ...
        tempCamera.AddComponent<TP_CameraK>();
        myCamera = tempCamera.GetComponent<TP_CameraK>() as TP_CameraK;
